...
const images2 = [{ src: con4, alt: 'con4' }];
const images3 = [
  { src: con5, alt: 'con5' },
  { src: con6, alt: 'con6' },
];
...
const images6 = [{ src: con13, alt: 'con13' }];
const images7 = [
  { src: con14, alt: 'con14' },
  { src: con15, alt: 'con15' },
  { src: con16, alt: 'con16' },
  ...
  return (
    <section className="construction-container">
      <header className="construction-header">
        <h1>Construction Works</h1>
        <p>
          Harvestwealth Nigeria Limited is a leading Engineering,
          Procurement, and Construction (EPC) Contractor in Nigeria with
          extensive experience in electricity supply construction. As a
          contractor in the electricity business, Harvestwealth Nigeria
          Limited has executed quality and cutting-edge construction
          projects across Nigeria for its clients.
        </p>
      </header>
      ...
      <div className="construction-features-container">
        <CarouselCard
          images={images1}
          text={'Construction of 7.5MVA Injection Substation'}
        />
        <CarouselCard
          images={images2}
          text={'Construction & Commissioning of 11KV Electrical Switchgear Panels'}
        />
        <CarouselCard
          images={images3}
          text={'Construction of 33KV Power Lines and 33KV/400V Substation'}
        />
        <CarouselCard
          images={images4}
          text={'Construction of 2.5MVA Indoor Substation'}
        />
        <CarouselCard
          images={images5}
          text={'Construction of Pole Mounted CSP Transformers'}
        />
        <CarouselCard
          images={images6}
          text={'Installation of 2500A Low Voltage Distribution'}
        />
      </div>

      <h2 className="construction-subheading">Off-Grid Construction</h2>
      <div className="construction-gallery">
        <CarouselCard
          images={images7}
          text={'20KW Off-Grid Solar Power System for Residential Homes'}
        />
      </div>
    </section>
  );
